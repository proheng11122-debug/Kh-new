...
const FeatureBadge: React.FC<{ children: React.ReactNode }> = ({ children }) => (
  <div style={{
    ...
    fontSize: 10, fontWeight: 700, padding: '6px 12px', borderRadius: 20, whiteSpace: 'nowrap',
  }}>{children}</div>
)

const RowItem: React.FC<{ label: string; value: string }> = ({ label, value }) => (
  <div style={{ display:'flex', padding:'4px 6px', fontSize:6, borderTop:'0.5px solid #EFEDE5', color:'#0B2A4A' }}>
  ...
  <div style={{ width:150, transform:'translateY(18px) rotate(-6deg)', zIndex:1 }}>
    <div style={{ background:'#08213A', borderRadius:20, padding:5, boxShadow:'0 20px 40px rgba(0,0,0,0.35)' }}>
      <div style={{ background:'#FAFAF8', borderRadius:15, overflow:'hidden' }}>
        <div style={{ background:'linear-gradient(135deg,#0C447C,#0B2A4A)', padding:'14px 8px', display:'flex', justifyContent:'space-between', alignItems:'center' }}>
        ...
        <div style={{ padding:8 }}>
          ...
          <div style={{ background:'#0B2A4A', borderRadius:7, padding:6, marginTop:6, display:'flex', justifyContent:'space-between' }}>
      ...
      <div style={{ background:'#FAFAF8', borderRadius:20, overflow:'hidden' }}>
        <div style={{ background:'linear-gradient(135deg,#0C447C,#0B2A4A)', padding:'12px 10px' }}>
          <div style={{ display:'flex', alignItems:'center', gap:6 }}>
            <div style={{ width:22, height:22, borderRadius:6, background:'rgba(255,255,255,0.18)', display:'flex', alignItems:'center', justifyContent:'center', color:'#fff', fontSize:9, fontWeight:700, flexShrink:0 }}>D</div>
...
const Banner: React.FC = () => (
  <div style={{
    ...
    <div style={{ position:'relative', textAlign:'center', marginBottom:28 }}>
      <div style={{ width:52, height:52, borderRadius:14, background:'#D9A441', display:'flex', alignItems:'center', justifyContent:'center', margin:'0 auto 10px' }}>
